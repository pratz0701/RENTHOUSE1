...
{
 echo "<tr><td>".$result['tenant_id']."</td><td>".$result['fname']."</td><td>".$result['lname']."</td><td>".$result['gender']."</td><td>".$result['dob']."</td><td>".$result['occupation']."</td><td>".$result['relationship']."</td></tr>";
}
echo "</table>";
?>
</div>
