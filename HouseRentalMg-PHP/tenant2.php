...
$query="select * from tenant t join member m on t.tenant_id=m.tenant_id";
$data=mysqli_query($conn,$query);
while($result=mysqli_fetch_assoc($data))
{
 echo "<tr><td>".$result['tenant_id']."</td><td>".$result['fname']." ".$result['lname']."</td><td>".$result['occupation']."</td><td>".$result['gender']."</td><td>".$result['dob']."</td><td>".$result['relationship']."</td></tr>";
}
echo "</table>";
?>
</div>
